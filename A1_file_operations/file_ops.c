/* Implement a simple char driver with open, read, write and release file operations. Create a
   simple user application to test the driver's functionality by transferring data from user to
   the driver and vice-versa. Use static device number assignment. */
